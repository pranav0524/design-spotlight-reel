...
const Contact = () => {
  ...
  const stats = [
    ...
    { icon: Users, number: "50+", label: "Projects Done" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <Card className="p-8 bg-card/50 backdrop-blur-sm border-border/50">
            <h3 className="text-2xl font-bold mb-6 gradient-secondary bg-clip-text text-transparent">
              Send us a message
            </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button 
                type="submit" 
                className="w-full gradient-primary text-white shadow-glow hover:shadow-glow-accent transition-smooth"
                size="lg"
              >
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {stats.map((stat, index) => (
                <Card key={index} className="p-6 text-center bg-card/50 backdrop-blur-sm border-border/50 hover-lift">
