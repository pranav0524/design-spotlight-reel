...
import { Megaphone, PenTool, Video, Image, CheckCircle, ArrowRight } from "lucide-react";
const Services = () => {
  const services = [{
    icon: Megaphone,
    ...
    features: ["Content Planning", "Community Management", "Analytics & Reporting", "Platform Optimization"],
    ...
    features: ["Copywriting", "Visual Design", "Brand Storytelling", "Content Strategy"],
    ...
    features: ["Short-form Videos", "Motion Graphics", "Color Grading", "Audio Enhancement"],
    ...
    features: ["Brand Guidelines", "Visual Identity", "Print Design", "Digital Assets"],
  ...
  return <section className="py-20 bg-secondary/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {services.map((service, index) => <Card key={index} className="p-8 hover-lift bg-card/50 backdrop-blur-sm border-border/50 group h-full">
              ...
              <Button variant="outline" className="w-full border-primary/20 hover:border-primary/40 hover:bg-primary/5 transition-smooth group">
                Learn More
        ...
        <Card className="p-8 md:p-12 bg-glass border-primary/20 shadow-glow text-center">
          <h3 className="text-2xl font-bold mb-4 text-gradient-secondary md:text-3xl">
            Ready to Transform Your Brand?
          </h3>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Let's work together to create compelling content that drives results and grows your business.
          </p>
          <Button size="lg" className="gradient-primary text-white shadow-glow hover:shadow-glow-accent transition-smooth px-8 py-6 text-lg">
            Start Your Project
