      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {stats.map((stat, index) => (
            <Card key={index} className="p-8 text-center bg-glass border-primary/20 hover-lift">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {features.map((feature, index) => (
            <Card key={index} className="p-6 hover-lift bg-card/50 backdrop-blur-sm border-border/50 group">
        ...
        <Card className="p-8 md:p-12 bg-glass border-primary/20 shadow-soft">
          <div className="text-center">
            <h3 className="text-2xl md:text-3xl font-bold mb-6 gradient-secondary bg-clip-text text-transparent">
              Our Mission
            </h3>
